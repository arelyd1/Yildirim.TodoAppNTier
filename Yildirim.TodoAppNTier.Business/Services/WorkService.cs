...
using Yildirim.TodoAppNTier.Business.Extensions;
...
namespace Yildirim.TodoAppNTier.Business.Services
{
    public class WorkService : IWorkService
    {
        ...
        {
            var validatorionResult = _createDtoValidator.Validate(dto);

            if (validatorionResult.IsValid)
            {
            ...
            else
            {
                ...
                return new Response<WorkCreateDto>(ResponseType.ValidationError, dto,validatorionResult.ConvertToCustomValidationError());
            }
        ...
        public async Task<IResponse<List<WorkListDto>>> GetAll()
        {
            ...
            //            IsCompeleted = work.IsCompeleted,
            //            Id = work.Id,
            //        });
